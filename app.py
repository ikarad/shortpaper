...
vectorizer_tf = joblib.load("X_smote_tf.pkl")
vectorizer_emb_svm = joblib.load("X_smote_embedding.pkl")
vectorizer_emb_rf = joblib.load("X_rus_embedding_tf.pkl")
...
# joblib.dump(bow_features, "bow_vectorizer.pkl")
